...
return [
    'modules' => [
        ...
        'Magezon_Core' => 1,
        'Magezon_Builder' => 1,
        'Bullseye_CheckoutSidebar' => 1,
        'Bullseye_TableRate' => 1,
        'Capturly_Capturly' => 1,
        ...
        'FME_SeoImagesAltTag' => 1,
        'FishPig_WordPress' => 0,
        'Fooman_PrintOrderPdf' => 1,
        'Hammer_BreadcrumbFix' => 1,
        'Hammer_CatCollection' => 1,
        'Hammer_CategoryOnHome' => 1,
        'Hammer_Cms' => 1,
        'Hammer_ContactReturn' => 0,
        'Hammer_ImportProductCustomOptions' => 1,
        'Hammer_LayeredNavImprove' => 1,
        'Hammer_PriceDecimal' => 1,
        'Magestore_Bannerslider' => 1,
        'Hammer_Widget' => 1,
        'Hammer_WyswygPdfUploader' => 0,
        'InverseParadox_CharacterLimit' => 1,
        'InverseParadox_CustomerAccountNumber' => 1,
        'Klarna_Core' => 1,
        ...
        'BlueFormBuilder_ConditionalLogic' => 1,
        'Magezon_UiBuilder' => 1,
        'Meetanshi_Flatshipping' => 1,
        'Ranosysmage_Deleteorder' => 1,
        'Swissup_Core' => 1,
        'Swissup_Recaptcha' => 1,
